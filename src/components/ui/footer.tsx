        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex items-center space-x-2">
           <Image src="/discord_logo.svg" alt="Connectomics Logo" width={32} height={32} />
            <span className="text-sm text-muted-foreground">© 2025 Connectomics. All rights reserved.</span>
          </div>

          <div className="flex items-center space-x-4">
            <Link href="https://discord.gg/bPmQt63b5Y" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors" aria-label="Discord">
